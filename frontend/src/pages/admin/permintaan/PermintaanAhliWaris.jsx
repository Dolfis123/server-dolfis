...
function PermintaanAhliWaris() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        "https://website.fahri.life/api/lihat-surat-ahli-waris-menunggu"
      );
  ...
  const handleDeleteClick = () => {
    if (selectSurat.id) {
      ...
      axios
        .delete(`https://website.fahri.life/api/hapus-surat-ahli-waris/${id}`)
        .then((res) => {
  ...
  const handleEditClick = () => {
    if (selectSurat.id) {
      ...
      axios
        .put(
          `https://website.fahri.life/api/update-all-surat-ahli-waris/${id}`,
          selectSurat
        )
        .then((res) => {
...
export default PermintaanAhliWaris;
