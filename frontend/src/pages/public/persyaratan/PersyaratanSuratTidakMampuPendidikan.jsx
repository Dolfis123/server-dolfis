...
function PersyaratanSuratTidakMampuPendidikan() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `https://website.fahri.life/api/lihat-surat-tidak-mampu/${hashed_id}`
      );
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://website.fahri.life/api/update-nomor-email/${hashed_id}`,
        formData
      );
      ...
      navigate(`/bukti-surat-tidak-mampu/${hashed_id}`);
    } catch (error) {
...
export default PersyaratanSuratTidakMampuPendidikan;
