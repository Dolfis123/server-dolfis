...
function PersyaratanSuratAhliWaris() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`/bukti-ket-ahli-waris/${hashed_id}`);
    } catch (error) {
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          <div className="text-center mb-6">
            <h3 className="text-2xl font-bold">
              Permintaan Surat Keterangan Ahli Waris
            </h3>
...
export default PersyaratanSuratAhliWaris;
