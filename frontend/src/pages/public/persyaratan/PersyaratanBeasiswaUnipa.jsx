...
function PersyaratanBeasiswaUnipa() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://website.fahri.life/api/update-nomor-email-beasiswa/${hashed_id}`,
        formData
      );
      ...
      navigate(`/bukti-beasiswa-unipa/${hashed_id}`);
    } catch (error) {
...
export default PersyaratanBeasiswaUnipa;
